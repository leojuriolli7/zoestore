...
import { listProductPerformance } from "@/query/analytics/listProductPerformance/handler";
import { listProductPerformanceSchema } from "@/query/analytics/listProductPerformance/schema";
...
async function getHandler(req: NextRequest) {
  ...
  const parsed = listProductPerformanceSchema.safeParse({
    startDate,
    endDate,
    limit,
    cursor,
  ...
  return await listProductPerformance(parsed.data);
}
